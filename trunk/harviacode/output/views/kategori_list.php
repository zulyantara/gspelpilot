...
<html>
    ...
    <body>
		...
		<th>Action</th>
			...
			<td><?php echo $kategori->judul_kat ?></td>
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('kategori/read/'.$kategori->id_kat),'Read'); 
				echo ' | '; 
				echo anchor(site_url('kategori/update/'.$kategori->id_kat),'Update'); 
				echo ' | '; 
				echo anchor(site_url('kategori/delete/'.$kategori->id_kat),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
				?>
			</td>
		</tr>
                <?php
