		...
		<div class="box box-primary">
			...
			<div class="box-body">
				<?php echo $form->open(); ?>
					...
					<?php if ( !empty($giatmaras) ): ?>
					<div class="form-group">
						<label for="giatmaras">Giatmara</label>
						<div>

							<div class="form-group">
								<select name="giatmara_id">
								<?php foreach ($giatmaras as $giatmara): ?>
								<option value="<?php echo $giatmara->id; ?>"><?php echo $giatmara->nama_giatmara; ?></option>
								<?php endforeach; ?>
								</select>
							</div>
