				...
				<li class="dropdown user user-menu">
					...
					<ul class="dropdown-menu">
						<li class="user-header">
							<p><?php  echo $this->session->userdata('username' ); echo $this->session->unset_userdata('admin_groups');?></p>
						</li>
...
<a href='gspel_kurikulum/pbn'><i class='fa fa-circle-o'></i> Pengesahan PGN</a>
