...
<link href='<?php echo base_url(); ?>/assets/plugins/timepicker/bootstrap-timepicker.min.css' rel='stylesheet' media='screen'>
<link href='<?php echo base_url(); ?>/assets/plugins/datatables/jquery.dataTables.min.css' rel='stylesheet' media='screen'>
<link href='<?php echo base_url(); ?>/assets/dist/admin/error_style.css' rel='stylesheet' media='screen'>
...
<script src='<?php echo base_url(); ?>/assets/dist/frontend/jquery_validate/jquery.validate.min.js'></script>
<script src='<?php echo base_url(); ?>/assets/plugins/timepicker/bootstrap-timepicker.min.js'></script>
...
<li class='treeview'>
<a href='#'>
<i class='fa fa-briefcase'></i> <span>Pelatih Baru (LPP04)</span> <span class="pull-right-container"><i class='fa fa-angle-left pull-right'></i></span>
</a>
<ul class="treeview-menu">
<li><a href='lpp04/permohonan_baru'><i class='fa fa-circle-o'></i> Permohonan Baru</a></li>

<li>
<a href="#"><i class='fa fa-circle-o'></i> <span>Temuduga</span>  <span class="pull-right-container"><i class='fa fa-angle-left pull-right'></i></span></a>
<ul class="treeview-menu">
...
<li class='treeview ' >
<a href='#'>
<i class='fa fa-briefcase'></i> <span>Pelatih Lanjutan (LPP09)</span> <span class="pull-right-container"><i class='fa fa-angle-left pull-right'></i></span></a>
<ul class='treeview-menu'>
<li><a href='pelatih_lanjutan/permohonan_baru'><i class='fa fa-circle-o'></i>Permohonan Baru</a></li>
<li><a href="#">
<i class='fa fa-circle-o'></i><span>Temuduga</span>  <span class="pull-right-container"><i class='fa fa-angle-left pull-right'></i></span></a>
<ul class="treeview-menu">
...
<li><a href='pelatih_lanjutan/pendaftaran'><i class='fa fa-circle-o'></i> Pendaftaran</a></li>
<!-- <li><a href='pelatih_lanjutan/pendaftaranb'><i class='fa fa-circle-o'></i> Pendaftaran Program Lain</a></li> --></ul></li>
 
<?php } elseif ($groups == 'trainer') { ?>
...
<a href='gspel_kurikulum/trainer2'><i class='fa fa-circle-o'></i> Pemarkahan</a></li><li>
<a href='gspel_kurikulum/status'><i class='fa fa-circle-o'></i> Status Penghantaran</a></li></ul></li>
