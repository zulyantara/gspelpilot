      ...
      <div class="panel panel-info panel-custom-horrible-red">
          <div class="panel-heading panel-heading-custom">
            ...
            <td width="10%">&nbsp;</td>
             ...
             <form action="<?php echo site_url('admin/Gspel_kurikulum/kembali1');?>" id="myform" name="myform" method="post">
            ...
            <table class ="table table-hover table-bordered" id = "myTable">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                  <?php if ($p->catatan_pengurus =="") { ?>
                   <input type="textarea"" name="catatan[<?php echo $no; ?>]" id="catatan" >
                 <?php  } else { ?>
                    <input type="textarea"" name="catatan[<?php echo $no; ?>]" id="catatan" value="<?php echo $p->catatan_pengurus;?>" disabled>
                 <?php } ?>
                  </td>
                    <td><?php if ($p->desc_status === "TP - Dihantar ke Pengurus" ) { ?>
                 ...
                 <input type="hidden" name="id_modul[<?php echo $no; ?>]" value="<?php echo $p->id_modul; ?>" >
...
<br><br>
              ...
              <tbody>
               ...
               <td>
                  ...
                  <?php if ($r->catatan_pengurus =="") { ?>
                    value="<?php echo $r->catatan_pengurus;?>"
                 <?php  } else { ?>
                       value="<?php echo $r->catatan_pengurus;?>" disabled
                 <?php } ?>
                  ></td>
                    <td><?php if ($r->desc_status === "TP - Dihantar ke Pengurus" ) { ?>
                    
                     <input type="checkbox" id="pilih" class="pilih" name="pilih2" value="<?php echo $no; ?>" >
                     <?php } else if($r->desc_status === "Pengurus - Dihantar ke PGN") {?>
                     <?php echo "Pengurus - Dihantar ke PGN";?>
                  <?php } else { ?>
              ...
              <button type="submit" id="submit" class="btn" name="action" class="submit" value="simpan" style="background-color:#000063 "><font color="white" form="myform">Kembalikan Ke TP</font></button>&nbsp;
               <a href="<?php echo site_url('admin/Gspel_kurikulum/approval7');?>/<?php echo $idSeq2;?>" type="button" class="btn" name="action" value="hantar" style="background-color: #000063"><font color="white">Kembali Ke Halaman Sebelumnya</font></a>
        </form>
