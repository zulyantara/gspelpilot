						...
						<table class ="table table-hover table-striped table-bordered" id = "myTable">
			                ...
			                foreach($moduldetail as $r) : 
								...
								<td><a href="<?php echo site_url('admin/Gspel_kurikulum/borang4/');?><?php echo $r->id_intake;?>/<?php echo $r->id_ref_kursus;?>/<?php echo $r->id_giatmara;?>/<?php echo $r->id_kursus;?>"  target="_blank"><img width="20px" height="20px" src="<?php echo base_url(); ?>/assets/images/ujian.png"></a></td>
									...
									<?php if ($r->saegm) {?>
									<img width="20px" height="20px" src="<?php echo base_url(); ?>/assets/images/tick.png">
									<input type="hidden" name="saegm[<?php echo $no; ?>]" value="1">
									<?php } else {}?>
									</td>
									<td>
									<?php if ($r->spgm) {?>
									<img width="20px" height="20px" src="<?php echo base_url(); ?>/assets/images/tick.png">
									<input type="hidden" name="spgm[<?php echo $no; ?>]" value="1">
									<?php } else {}?>
									</td>
									<td>
									<?php if ($r->skgm) {?>
									<img width="20px" height="20px" src="<?php echo base_url(); ?>/assets/images/tick.png">
									<input type="hidden" name="skgm[<?php echo $no; ?>]" value="1">
									<?php } else {}?>
									</td>
									<td>
									<?php if ($r->bahagian_a == 1 AND $r->bahagian_b == 1 AND $r->pengurus_sah == NULL ) { ?> <!-- //&& $r->bahagian_b == 1  -->
									...
									<?php } else if($r->status_isi_markah == 4 || $r->status_isi_markah == 6){ ?>
									<?php
									// var_dump($r->pgn_sah);
