						...
						<table class ="table table-hover table-striped table-bordered" id = "myTable">
			                ...
			                foreach($moduldetail as $r) : 
								...
								<tr>
									...
									<td>
									<?php if ($r->status_isi_markah == 6 && $r->bahagian_b == 1 ) { ?>
									<input type="checkbox" id="pilih" class="pilih" name="pilih[<?php echo $no; ?>]" value="<?php echo $no; ?>" >
									<input type="hidden" name="idsah[]" value="<?php echo $r->id_pengurus_sah; ?>">
									<?php } else if($r->status_isi_markah == 7){ ?>
									<?php
									// var_dump($r->pgn_sah);
									if ($r->pgn_sah != NULL || $r->ppkl_sah != '') {
