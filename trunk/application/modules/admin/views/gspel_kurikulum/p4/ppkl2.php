...
.panel-custom-horrible-red > .panel-heading {
  ...
  <div class="col-md-12">
    <div class="box">
        ...
        <form class="form-horizontal" action="<?php echo site_url('admin/Gspel_kurikulum/ppkl2');?>" method="post">
        <fieldset>
                ...
                <div class ="table table-responsive">
                  <table class ="table table-hover table-striped table-bordered" id = "myTable">
                    ...
                    <tbody>
                      ...
                      <a href="<?php if($r->kod_modul =="BAHAGIAN B"){
                          echo site_url('admin/Gspel_kurikulum/ppkl5/');}
                        else{
                          echo site_url('admin/Gspel_kurikulum/ppkl3/'); 
                        }
                      ...
                      <?php } ?>
                        <a href="<?php if($r->kod_modul =="BAHAGIAN B"){
                       echo site_url('admin/Gspel_kurikulum/ppkl6/');}
                        else{
                          echo site_url('admin/Gspel_kurikulum/ppkl4/');} 
                      ...
                      <?php } ?>
                       ...
                       echo site_url('admin/Gspel_kurikulum/ppkl6/');}
                          ...
                          echo site_url('admin/Gspel_kurikulum/ppkl4/');}  ?><?php echo $r->id_ref_kursus;?>/<?php echo $r->kod_modul;?>/<?php echo "Q";?>/<?php echo $r->id_giatmara;?>/<?php echo $r->id_kursus;?>/<?php echo 3;?>/<?php echo $kursus;?>/<?php echo $giatmara;?>/<?php echo $intake;?>/<?php echo $jeniskursus;?>"><?php echo $r->dikembalikan; ?></a></td>
                      ...
                      <?php } ?>
                       ...
                       echo site_url('admin/Gspel_kurikulum/ppkl6/');}
                          ...
                          echo site_url('admin/Gspel_kurikulum/ppkl4/');}  ?><?php echo $r->id_ref_kursus;?>/<?php echo $r->kod_modul;?>/<?php echo "Q";?>/<?php echo $r->id_giatmara;?>/<?php echo $r->id_kursus;?>/<?php echo 4;?>/<?php echo $kursus;?>/<?php echo $giatmara;?>/<?php echo $intake;?>/<?php echo $jeniskursus;?>"><?php echo $r->hantar_ke_pgn; ?></a></td>
                      ...
                      <?php } ?>
                       ...
                       echo site_url('admin/Gspel_kurikulum/ppkl6/');}
                          ...
                          echo site_url('admin/Gspel_kurikulum/ppkl4/');}  ?><?php echo $r->id_ref_kursus;?>/<?php echo $r->kod_modul;?>/<?php echo "Q";?>/<?php echo $r->id_giatmara;?>/<?php echo $r->id_kursus;?>/<?php echo 5;?>/<?php echo $kursus;?>/<?php echo $giatmara;?>/<?php echo $intake;?>/<?php echo $jeniskursus;?>"><?php echo $r->dikembalikan_oleh_pgn; ?></a></td>
                      ...
                      <?php } ?>
                       ...
                       echo site_url('admin/Gspel_kurikulum/ppkl6/');}
                          ...
                          echo site_url('admin/Gspel_kurikulum/ppkl4/');}  ?><?php echo $r->id_ref_kursus;?>/<?php echo $r->kod_modul;?>/<?php echo "Q";?>/<?php echo $r->id_giatmara;?>/<?php echo $r->id_kursus;?>/<?php echo 6;?>/<?php echo $kursus;?>/<?php echo $giatmara;?>/<?php echo $intake;?>/<?php echo $jeniskursus;?>"><?php echo $r->hantar_ke_ppkl; ?></a></td>
                      ...
                      <?php } ?>
                        ...
                        echo site_url('admin/Gspel_kurikulum/ppkl6/');}
                          ...
                          echo site_url('admin/Gspel_kurikulum/ppkl4/');} ?><?php echo $r->id_ref_kursus;?>/<?php echo $r->kod_modul;?>/<?php echo "Q";?>/<?php echo $r->id_giatmara;?>/<?php echo $r->id_kursus;?>/<?php echo 8;?>/<?php echo $kursus;?>/<?php echo $giatmara;?>/<?php echo $intake;?>/<?php echo $jeniskursus;?>"><?php echo $r->dikembalikan_oleh_ppkl; ?></a></td>
                      ...
                      <?php } ?>
                       ...
                       echo site_url('admin/Gspel_kurikulum/ppkl6/');}
                          ...
                          echo site_url('admin/Gspel_kurikulum/ppkl4/');}  ?><?php echo $r->id_ref_kursus;?>/<?php echo $r->kod_modul;?>/<?php echo "Q";?>/<?php echo $r->id_giatmara;?>/<?php echo $r->id_kursus;?>/<?php echo 7;?>/<?php echo $kursus;?>/<?php echo $giatmara;?>/<?php echo $intake;?>/<?php echo $jeniskursus;?>"><?php echo $r->disahkan_oleh_ppkl; ?></a></td>
                          </tr>
                      <?php endforeach; ?>
                  ...
                  <?php if (!empty($modul)) { ?>
                   ...
                   <?php if ($groups == 'admin') { ?>
                    ...
                    <a href="<?php echo site_url('admin/Gspel_kurikulum/ppkl7');?>/<?php echo $r->id_kursus; ?>/<?php echo $r->jenis;?>/<?php echo $kursus;?>/<?php echo $giatmara;?>/<?php echo $intake;?>/<?php echo $jeniskursus;?>/<?php echo $negeri;?>" type="button" class="btn" name="action" value="hantar" style="background-color: #000063"><font color="white">Pengesahan</font></a>

                  <?php }else{ ?>
                  
                   <a href="<?php echo site_url('admin/Gspel_kurikulum/ppkl7');?>/<?php echo $r->id_kursus; ?>/<?php echo $r->jenis;?>/<?php echo $kursus;?>/<?php echo $giatmara;?>/<?php echo $intake;?>/<?php echo $jeniskursus;?>/<?php echo $negeri;?>" type="button" class="btn" name="action" value="hantar" style="background-color: #000063"><font color="white">Pengesahan PBKL</font></a>
