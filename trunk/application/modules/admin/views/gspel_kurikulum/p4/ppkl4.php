          ...
          <tr><td colspan="3" align="center"><b>STATUS</b></td>
                  ...
                  <td>
                    ...
                    <?php 
                      ...
                      foreach($modul as $r) : ?>
<a href="<?php echo site_url('admin/Gspel_kurikulum/ppkl4/');?><?php echo $r->id_kursus;?>/<?php echo $r->kod_modul;?>/<?php echo $r->id_modul;?>/<?php echo $r->id_giatmara;?>/<?php echo $r->id_set;?>/<?php echo 0;?>/<?php echo $giatmara;?>/<?php echo $kursus;?>/<?php echo $jeniskursus;?>/<?php echo $intake;?>/<?php echo $negeri;?>"><?php
...
<a href="<?php echo site_url('admin/Gspel_kurikulum/ppkl4/');?><?php echo $r->id_kursus;?>/<?php echo $r->kod_modul;?>/<?php echo $r->id_modul;?>/<?php echo $r->id_giatmara;?>/<?php echo $r->id_set;?>/<?php echo 1;?>/<?php echo $giatmara;?>/<?php echo $kursus;?>/<?php echo $jeniskursus;?>/<?php echo $intake;?>/<?php echo $negeri;?>"><?php
                              ...
                              <tr>
                                ...
                                <td>
                    <?php   foreach($modul as $r) : ?>
<a href="<?php echo site_url('admin/Gspel_kurikulum/ppkl4/');?><?php echo $r->id_kursus;?>/<?php echo $r->kod_modul;?>/<?php echo $r->id_modul;?>/<?php echo $r->id_giatmara;?>/<?php echo $r->id_set;?>/<?php echo 2;?>/<?php echo $giatmara;?>/<?php echo $kursus;?>/<?php echo $jeniskursus;?>/<?php echo $intake;?>/<?php echo $negeri;?>"><?php
                                ...
                                <td>
                    <?php   foreach($modul as $r) : ?>
<a href="<?php echo site_url('admin/Gspel_kurikulum/ppkl4/');?><?php echo $r->id_kursus;?>/<?php echo $r->kod_modul;?>/<?php echo $r->id_modul;?>/<?php echo $r->id_giatmara;?>/<?php echo $r->id_set;?>/<?php echo 3;?>/<?php echo $giatmara;?>/<?php echo $kursus;?>/<?php echo $jeniskursus;?>/<?php echo $intake;?>/<?php echo $negeri;?>"><?php
                              ...
                              <tr>
                                ...
                                <td>
                    <?php   foreach($modul as $r) : ?>
<a href="<?php echo site_url('admin/Gspel_kurikulum/ppkl4/');?><?php echo $r->id_kursus;?>/<?php echo $r->kod_modul;?>/<?php echo $r->id_modul;?>/<?php echo $r->id_giatmara;?>/<?php echo $r->id_set;?>/<?php echo 4;?>/<?php echo $giatmara;?>/<?php echo $kursus;?>/<?php echo $jeniskursus;?>/<?php echo $intake;?>/<?php echo $negeri;?>"><?php
                              ...
                              <tr>
                                ...
                                <td>
                    <?php   foreach($modul as $r) : ?>
<a href="<?php echo site_url('admin/Gspel_kurikulum/ppkl4/');?><?php echo $r->id_kursus;?>/<?php echo $r->kod_modul;?>/<?php echo $r->id_modul;?>/<?php echo $r->id_giatmara;?>/<?php echo $r->id_set;?>/<?php echo 5;?>/<?php echo $giatmara;?>/<?php echo $kursus;?>/<?php echo $jeniskursus;?>/<?php echo $intake;?>/<?php echo $negeri;?>"><?php
                                ...
                                <td>
                    <?php   foreach($modul as $r) : ?>
<a href="<?php echo site_url('admin/Gspel_kurikulum/ppkl4/');?><?php echo $r->id_kursus;?>/<?php echo $r->kod_modul;?>/<?php echo $r->id_modul;?>/<?php echo $r->id_giatmara;?>/<?php echo $r->id_set;?>/<?php echo 6;?>/<?php echo $giatmara;?>/<?php echo $kursus;?>/<?php echo $jeniskursus;?>/<?php echo $intake;?>/<?php echo $negeri;?>"><?php
                                ...
                                <td>
                    <?php   foreach($modul as $r) : ?>
<a href="<?php echo site_url('admin/Gspel_kurikulum/ppkl4/');?><?php echo $r->id_kursus;?>/<?php echo $r->kod_modul;?>/<?php echo $r->id_modul;?>/<?php echo $r->id_giatmara;?>/<?php echo $r->id_set;?>/<?php echo 7;?>/<?php echo $giatmara;?>/<?php echo $kursus;?>/<?php echo $jeniskursus;?>/<?php echo $intake;?>/<?php echo $negeri;?>"><?php
