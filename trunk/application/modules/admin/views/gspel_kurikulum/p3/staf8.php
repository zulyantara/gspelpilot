      ...
      <div class="panel panel-info panel-custom-horrible-red">
          <div class="panel-heading panel-heading-custom">
            ...
            <td width="10%">&nbsp;</td>
             ...
             <form action="<?php echo site_url('admin/Gspel_kurikulum/kembali2');?>" id="myform" name="myform" method="post">
            ...
            <table class ="table table-hover table-bordered" id = "myTable">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                  <?php if ($p->catatan_pgn =="") { ?>
                   <input type="textarea"" name="catatan[<?php echo $no; ?>]" id="catatan" >
                 <?php  } else { ?>
                    <input type="textarea"" name="catatan[<?php echo $no; ?>]" id="catatan" value="<?php echo $p->catatan_pgn;?>" disabled>
                 <?php } ?>
                  </td>
                    <td><?php if ($p->desc_status === "Pengurus - Dihantar ke PGN" ) { ?>
...
<br><br>
              ...
              <tbody>
                ...
                <tr>
                 ...
                 <td>
                  ...
                  <td>
                    <?php if($r->keusahawanan == "0"){ echo "LULUS";}
                   else{echo "GAGAL";}
                    ?>              
                  </td>
                  <td>
                  <?php if( $r->puji == "0"){ echo "TERAMPIL";}
                   else{echo "BELUM TERAMPILAN";}
                    ?>              
                  </td>
                     <td>
                    <?php 
                ...
                <td>
                  ...
                  <?php if ($r->catatan_pgn =="") { ?>
                    value="<?php echo $r->catatan_pgn;?>"
                 <?php  } else { ?>
                       value="<?php echo $r->catatan_pgn;?>" disabled
                 <?php } ?>
                  ></td>
                    <td><?php if ($r->desc_status === "Pengurus - Dihantar ke PGN" ) { ?>
                    
                     <input type="checkbox" id="pilih" class="pilih" name="pilih2" value="<?php echo $no; ?>" >
                     <?php } else if($r->desc_status === "PGN - Dihantar ke PBKL") {?>
                     <?php echo "PGN - Dihantar ke PBKL";?>
                  <?php } else { ?>
              ...
              <input type="hidden" name="idSeq" value="<?php echo $idSeq; ?>" >
               ...
               <a href="<?php echo site_url('admin/Gspel_kurikulum/pbn7');?>/<?php echo $idSeq2;?>" type="button" class="btn" name="action" value="hantar" style="background-color: #000063"><font color="white">Kembali Ke Halaman Sebelumnya</font></a>
        </form>
