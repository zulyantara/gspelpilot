						...
						<table class ="table table-hover table-striped table-bordered" id = "myTable">
			                ...
			                foreach($moduldetail as $r) : 
								...
								<tr>
									...
									<td><a href="<?php echo site_url('admin/Gspel_kurikulum/pbn8/');?><?php echo $r->nama_penuh;?>/<?php echo $r->no_mykad;?>/<?php echo $r->no_pelatih;?>/<?php echo $r->gcpa;?>/<?php echo $r->kehadiran;?>/<?php echo $r->nama_kursus;?>/<?php echo $r->id_pelatih;?>/<?php echo $idSeq2; ?>"><?php echo $r->jumlah_modul_dihantar; ?></a></td>
									...
									<?php if( $r->status_isi_markah == 7 ) { ?>
									<td>
									<?php if ($r->sklgm1  == "on" or $r->sklgm1 == "1") { ?>
									<img width="20px" height="20px" src="<?php echo base_url(); ?>/assets/images/tick.png">
									...
									<img width="20px" height="20px" src="<?php echo base_url(); ?>/assets/images/tick.png">
									<input type="hidden" name="sijil" value="smgm">
									<?php 
									} else {}
									?>
									</td>
									...
									<td>
									<?php if ($r->sklgm1  == "on" or $r->sklgm1 == "1") {?>
									<input type="checkbox" name="sklgm[<?php echo $no; ?>]" id="sklgm" checked >
									<?php } else { ?>
										<input type="checkbox" name="sklgm[<?php echo $no; ?>]" id="sklgm"  value ="" >
									<?php }?>
									</td>
									<td>
									<?php if ($r->smgm  == "on" or $r->smgm == "1") {?>
									...
									<td>
									<?php if ($r->bahagian_a == 1 && $r->bahagian_b == 1 ) { ?>
