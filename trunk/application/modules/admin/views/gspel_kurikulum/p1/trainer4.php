...
// 		var hal = pbteori + pbamali;
// 		var hal2 = pmteori + pmamali;
//        	var jumlah = (hal*0.7) + (hal2*0.3) ;
// 		var jm = roundToTwo(jumlah);

//        	if ($('#pbamali'+no).val() > 80) {
           
//             alert('Sila isi dari 0 hingga 80 sahaja');
//             document.getElementById("pbamali"+no).value = '';
//         }else{
//         	document.getElementById("coba2"+no).value = jumlah.toFixed(2);
//         }
//         });
// }
...
//             alert('Sila isi dari 0 hingga 80 sahaja');
//             document.getElementById("pbamali").value = '';
//         }else{
//         	document.getElementById("coba").value = jumlah.toFixed(2);
//         }
//         });
//    });
...
//        	if ($('#pmteori'+no).val() > 20) {
           
//             alert('Sila isi dari 0 hingga 20 sahaja');
//             document.getElementById("#pmteori"+no).value = '';
//         }else{
//         	document.getElementById("coba"+no).value = jumlah.toFixed(2);
//         }
...
//             alert('Sila isi dari 0 hingga 20 sahaja');
//             document.getElementById("pmteori").value = '';
//         }else{
//         	document.getElementById("coba").value = jumlah.toFixed(2);
//         }
//         });
...
//        $('#pmamali').keyup(function () { 
//        	var p = $('#pbteori').val();
// 		var q = $('#pbamali').val();
// 		var r = $('#pmteori').val();
// 		var s = $('#pmamali').val();

// 		var pbteori = parseFloat(p);
// 		var pbamali = parseFloat(q);
// 		var pmteori = parseFloat(r);
// 		var pmamali = parseFloat(s);
// 		var hal = pbteori + pbamali;
// 		var hal2 = pmteori + pmamali;
//        	var jumlah = (hal*0.7) + (hal2*0.3) ;
...
//              alert('Sila isi dari 0 hingga 80 sahaja');
//              document.getElementById("pmamali").value = '';
//         }else{
//         	document.getElementById("coba").value = jumlah.toFixed(2);
//         }
//         });
