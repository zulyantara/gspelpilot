<div class="box box-primary box-solid">
    ...
    <div class="box-body">
       <form class="form-horizontal" action="<?php echo site_url('admin/Pelatih_lanjutan/kelulusan_permohonan_2'); ?>" id="myform" name="myform" method="post">
                    ...
                    <tbody>
                        ...
                        if($row_data)
                        {
                            foreach($row_data as $r)
                            {
                                ...
                                <tr>
                                    <td><?php echo $ni; ?></td>
                                    <td><?php echo strtoupper(strtolower($r->nama_penuh)); ?></td>
                                    <td><?php echo $r->no_mykad; ?></td>
                                    <td><?php echo $r->no_pelatih; ?></td>
                                    <td><?php echo $r->no_hp; ?></td>
                                    <td>
                                        <?php
                                        if ($r->kategori_program == "LL")
                                        {
                                            echo "Latihan Lanjutan";
                                        }
                                        else if ($r->kategori_program == "RN")
                                        {
                                            echo "Rintis Niaga";
                                        }
                                        else if ($r->kategori_program == "PP")
                                        {
                                            echo "Program Pertandingan";
                                        }
                                        else if ($r->kategori_program == "PK")
                                        {
                                            echo "Program Khas";
                                        }
                                        else
                                        {
                                            echo $r->kategori_program;
                                        }
                                        ?>
                                    </td>
                                    ...
                                    <td>
                                        <a href="<?php echo site_url('admin/pelatih_lanjutan/pengesahan/'.$r->id_permohonan."/".$r->id_permohonan_kursus_lpp09."/".$r->id_giatmara."/permohonan_2");?>" class="btn btn-primary btn-sm" type="button" name="action">LULUS</a>
