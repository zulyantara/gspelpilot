	...
	<div class="col-md-12">
      ...
      <div class="panel panel-info panel-custom-horrible-red">
  				<div class="panel-heading panel-heading-custom">
  					<h4 style="color: white">Tambah Ketua Kluster</h4>
  				</div>

    				<div class="panel-body">
  					<div class ="">

  		<form class="form-horizontal" action="<?php echo site_url('admin/Konfigurasi_kurikulum/storeketuakluster');?>" method="post">
        <fieldset>
