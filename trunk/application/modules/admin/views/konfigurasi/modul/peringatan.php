...
.panel-custom-horrible-red > .panel-heading {
    ...
    border-color:  #000063  ;
		...
		<section class="content-header">
			...
			<ol class="breadcrumb">
			<li class=''><a href=''>Home</a></li><li class='active'>Pengurusan Modu;</li></ol>		
		</section>
	...
	<div class="col-md-12">
      ...
      <div class="panel panel-info panel-custom-horrible-red">
  				<div class="panel-heading panel-heading-custom">
  					<h4 style="color: white" align="center">“ Terdapat pemarkahan yang telah direkodkan bagi modul ini. Adakah anda pasti untuk mengemaskini modul ini?”</h4><!-- <h4 style="color:red" align="center">DILARANG PADAM</h4> -->
  				</div>
    				...
    				<div class="panel-body">
						...
						<table class ="table table-hover table-striped table-bordered" id = "myTable">
							<thead style ="background-color:#b3b3b3" style="text-align: center;">
								<tr style="text-align: center;">
									...
									<th style="text-align: center;">Sesis</th>
					 ...
					 <a href="<?php echo site_url('admin/Konfigurasi_kurikulum/deletelagimodul/');?><?php echo $r->idmodul;?>/<?php echo $r->idkursus;?>/<?php echo $r->idkluster;?>" class="btn padam" name="action" id="padam" style="background-color:#000063"  ><font color="white">Padam</font></a> &nbsp;
