    ...
    <div class="box ">
        ...
        <div class="form-group">
          ...
          <div class="col-md-4">
			...
			<?php if ($groups == 'admin') { ?>
             <?php }else{ ?>
            &nbsp;<input id="tambah" name="tambah" type="submit" class="btn" style="background-color: #000063;color:white" value="Kemaskini">
             <?php } ?>
		  </div>
        </div>
            ...
            <table class ="table table-hover table-striped table-bordered" id = "myTable">
              <thead style ="background-color:#b3b3b3" style="text-align: center;">
                <tr style="text-align: center;">
                 ...
                 <th style="text-align: center;">Nama Kursus <br>(Kod Kursus)</th>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td align="center"><?php echo $r->nama_kursus."<br>(".$r->kod_kursus.")";?></td>
