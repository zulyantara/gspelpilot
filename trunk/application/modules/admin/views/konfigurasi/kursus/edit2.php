...
.panel-custom-horrible-red > .panel-heading {
    ...
    border-color:  #000063  ;
		...
		<section class="content-header">
			...
			<ol class="breadcrumb">
			<li class=''><a href=''>Home</a></li><li class='active'>Pengurusan Kursus2</li></ol>		
		</section>
...
<div class="row" id="one" >
	<div class="col-md-12">
      ...
      <div class="panel panel-info panel-custom-horrible-red">
  		...
  		<form class="form-horizontal col-md-12" action="<?php echo site_url('admin/Konfigurasi_kurikulum/update_kursus');?>" method="post">
        <fieldset>
       <!--  <table> -->
          
            <div class="col-md-6">
        <?php 
//print_r($kursusdetail);die();
        ...
        <div class="form-group">
          ...
          <div class="col-md-6">
          <input type="text" style="width:138%" name="nama" class="form-control" value="<?php echo $r->nama_kursus; ?>" >
          </div>
        </div>
         ...
         <div class="form-group">
          ...
          <div class="col-md-6">
          <input type="text" style="width:138%" name="sijil" class="form-control" value="<?php echo $r->nama_kursus_sijil; ?>">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-md-6">
          <input type="number" style="width:138%" name="latihanpusat"  class="form-control" value="<?php echo $r->tempoh_pusat; ?>">
          </div>
        </div>
...
<div class="col-md-6">
        ...
        <div class="form-group">
          ...
          <div class="col-md-6">
          <input type="text" style="width:138%" name="kodekursus" class="form-control" value="<?php echo $r->kod_kursus; ?>" >
          </div>
        </div>
         ...
         <div class="form-group">
          ...
          <div class="col-md-6">
          <input type="text" style="width:138%" name="kodeskm" class="form-control" value="<?php echo $r->kod_skm;?>">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-md-6">
          <input type="number" style="width:138%" name="latihanindustri" class="form-control" value="<?php echo $r->tempoh_industri; ?>">
          </div>
        </div>
