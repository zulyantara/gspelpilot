...
<form class="form-horizontal" action="<?php echo site_url('admin/Gspel_kewangan/hpenjanaan_lpp09'); ?>" method="post">
    <div class="row">
                ...
                <div class="box">
                    <div class="panel panel-info panel-custom-horrible-red">
                        <div class="panel-heading panel-heading-custom">
                            <h4 style="color: white">Penjanaan LPP09 (Pendaftaran Pelatih Baru)</h4>
                        </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#pagetitle").text("History Penjanaan LPP09");
    });
