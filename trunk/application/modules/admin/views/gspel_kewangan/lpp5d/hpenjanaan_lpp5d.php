...
<form class="form-horizontal" action="<?php echo site_url('admin/Gspel_kewangan/hpenjanaan_lpp5d'); ?>" method="post">
    <div class="row">
                ...
                <div class="box">
                    <div class="panel panel-info panel-custom-horrible-red">
                        <div class="panel-heading panel-heading-custom">
                            <h4 style="color: white">Penjanaan LPP5D (Pembetulan Maklumat Peribadi Pelatih)</h4>
                        </div>
                                                    ...
                                                    if ($data)
                                                        foreach ($data as $r) :
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?php echo $r->penjana; ?></td>
                                                                <td><?php echo date("d/m/Y", strtotime($r->dijana_pada)); ?></td>
                                                                <td><input type="checkbox" id="pilih" class="pilih" name="pilih[<?php echo $r->id; ?>]" ></td>
                                                            </tr>
                                                        <?php endforeach; ?>
                                                </tbody>
                                            </table>
                        ...
                        <div class="panel-footer">
                            ...
                            <button type="submit" class="btn btn-success" id ="jana" name="action" value="jana">Jana Semula yang Terpilih</button>
                        </div>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#pagetitle").text("History Penjanaan LPP5D");
    });
