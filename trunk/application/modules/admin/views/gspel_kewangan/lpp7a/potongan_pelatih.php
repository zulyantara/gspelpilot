                                    ...
                                    <table class ="table table-hover table-bordered" id = "myTable">
                                        ...
                                        <tbody>
                                            ...
                                            if ($dataLpp7a) {
                                                ?>
                                                <tr>
                                                    <td colspan="4" style="background-color: #b3b3b3; color: #fff301"><b>LPP7A</b></td>
                                                </tr>
                                                <?php
                                                $no = 0;
...
<!--                                            <tr>
                     ...
                     <a data-toggle="modal" class="open-Dialog btn btn-default" href="<?php echo site_url("admin/Gspel_kewangan/perubahan_potongan_elaun/$idPelatih/$idNegeri/$idGiatmara/$idKursus/$idIntake/$namaPelatih/"); ?>">Kembali ke Halaman Sebelumnya</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo site_url('admin/Gspel_kewangan/tambah_potongan_pelatih'); ?>" method="post">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="kekerapan" name="kekerapan" readonly="true">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div id="datepicker1" class="input-group date">
                                <input class="form-control" type="text" name="tarikh_mula" id="tarikh_mula" required="true" readonly="true"/>
                        ...
                        <div class="form-group">
                            ...
                            <div id="datepicker1" class="input-group date">
                                <input class="form-control" type="text" name="tarikh_tamat" id="tarikh_tamat" required="true" readonly="true"/>
                                <span class="input-group-addon">
                                    <i class="glyphicon glyphicon-calendar"></i>
                                </span>
                            </div>
