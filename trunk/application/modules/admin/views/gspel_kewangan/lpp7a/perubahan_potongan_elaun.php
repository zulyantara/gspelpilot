...
<form class="form-horizontal" action="<?php echo site_url('admin/Gspel_kewangan/perubahan_potongan_elaun'); ?>" method="post">
    <div class="row">
                                                ...
                                                <tbody>
                                                    ...
                                                    if ($data)
                                                        foreach ($data as $r) :
                                                            ...
                                                            <tr>
                                                                <td><?php echo ++$no; ?></td>
                                                                <td><a href="<?php echo site_url('admin/Gspel_kewangan/potongan_pelatih/');?><?php echo $r->id_pelatih;?>/<?php echo $idNegeri;?>/<?php echo $idGiatmara;?>/<?php echo $idKursus;?>/<?php echo $idIntake;?>/<?php echo $nama;?>"><?php echo $r->nama_penuh; ?></a></td>
