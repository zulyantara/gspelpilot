        ...
        <div class="box ">
            <div class="panel panel-custom-horrible-red"  >
                ...
                <div class="panel-body" >
                    <form class="form-horizontal" action="<?php echo site_url('admin/Pusat_giatmara/tukar_giatmara_kursus'); ?>" method="post">
                        <fieldset>
                                                    ...
                                                    foreach ($dataPelatih as $r) :
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><a data-toggle="modal" data-id="<?php echo $r->id_pelatih; ?>"
                                                                   ...
                                                                   title="Kursus" class="open-Dialog btn <?php echo (($r->kursus_baru_lpp10) ? 'btn-danger fa fa-ban' : 'btn-primary fa fa-pencil'); ?>" href="<?php echo (($r->kursus_baru_lpp10) ? '' : '#myModal'); ?>"></a></td>
                                                            <td><a data-toggle="modal" data-id="<?php echo $r->id_pelatih; ?>"
                                                                   data-kursus="<?php echo $idKursus; ?>"
                                                                   data-jenis="<?php echo $katPelatih; ?>"
                                                                   data-intake="<?php echo $idIntake; ?>"
                                                                   ...
                                                                   title="Pusat" class="open-Dialog2 btn <?php echo (($r->giatmara_baru_lpp10) ? 'btn-danger fa fa-ban' : 'btn-primary fa fa-pencil'); ?>" href="<?php echo (($r->giatmara_baru_lpp10) ? '' : '#myModal2'); ?>"></a></td>
                                                        </tr>
                                                    <?php endforeach; ?>
                                            </tbody>
                                        </table>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo site_url('admin/Pusat_giatmara/tukar_giatmara_kursus'); ?>" method="post">
                    <div class="form-group">
...
<script>
    $(document).ready(function () {
        $("#pagetitle").text("Tukar GIATMARA / Kursus (LPP10)");
