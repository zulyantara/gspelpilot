        ...
        <div class="box ">
            <div class="panel panel-custom-horrible-red"  >
                ...
                <div class="panel-body" >
                    <form class="form-horizontal" action="<?php echo site_url('admin/Pusat_giatmara/pengurusan_pelatih'); ?>" method="post">
                        <fieldset>
                                                    ...
                                                    foreach ($dataPelatih as $r) :
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><a data-toggle="modal" data-id="<?php echo $r->id_pelatih; ?>"
                                                                   ...
                                                                   title="Penukaran Nama Pelatih (LPP5A)" class="open-Dialog btn <?php echo (($r->lpp5a) ? 'btn-danger fa fa-ban' : 'btn-primary fa fa-pencil'); ?>" href="<?php echo (($r->lpp5a) ? '' : '#myModal'); ?>"></a></td>
                                                            <td><a data-toggle="modal" data-id="<?php echo $r->id_pelatih; ?>"
                                                                   data-kursus="<?php echo $idKursus; ?>"
                                                                   data-jenis="<?php echo $katPelatih; ?>"
                                                                   data-intake="<?php echo $idIntake; ?>"
                                                                   ...
                                                                   data-lahirbaru="<?php echo date('d-m-Y', strtotime($r->tarikh_lahir)); ?>"
                                                                   data-umur="<?php echo $r->umur; ?>"
                                                                   data-jantina="<?php echo $r->jantina; ?>"
                                                                   title="LLP5B – Pembetulan MyKAD" class="open-Dialog2 btn <?php echo (($r->lpp5b) ? 'btn-danger fa fa-ban' : 'btn-primary fa fa-pencil'); ?>" href="<?php echo (($r->lpp5b) ? '' : '#myModal5B'); ?>"></a></td>
                                                            <td><a data-toggle="modal" data-id="<?php echo $r->id_pelatih; ?>"
                                                                   data-kursus="<?php echo $idKursus; ?>"
                                                                   data-jenis="<?php echo $katPelatih; ?>"
                                                                   data-intake="<?php echo $idIntake; ?>"
                                                                   ...
                                                                   title="LLP5D – Pembetulan Maklumat Lain" class="open-Dialog3 btn <?php echo (($r->lpp5d) ? 'btn-danger fa fa-ban' : 'btn-primary fa fa-pencil'); ?>" href="<?php echo (($r->lpp5d) ? '' : '#myModal5D'); ?>"></a></td>
                                                            <td><a data-toggle="modal" data-id="<?php echo $r->id_pelatih; ?>"
                                                                   data-kursus="<?php echo $idKursus; ?>"
                                                                   data-jenis="<?php echo $katPelatih; ?>"
                                                                   data-intake="<?php echo $idIntake; ?>"
                                                                   ...
                                                                   title="LLP06 – Pembetulan Maklumat Bank" class="open-Dialog4 btn <?php echo (($r->lpp06) ? 'btn-danger fa fa-ban' : 'btn-primary fa fa-pencil'); ?>" href="<?php echo (($r->lpp06) ? '' : '#myModal06'); ?>"></a></td>
                                                            <td><?php //echo '<a href="' . site_url('admin/Pusat_giatmara/butir_peribadi/') . $r->id_pelatih . '" class="fa fa-pencil-square">';   ?></td>
                                                        </tr>
                                                    <?php endforeach; ?>
                                            </tbody>
                                        </table>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div id="datepicker1" class="input-group date">
                                <input class="form-control" type="text" name="tarikh_lahir_baru" id="tarikh_lahir_baru" required="true" value ="<?php echo ($res_temudugatetapan[0]->tawaran_mula_elaun) ? date('d-m-Y', strtotime($res_temudugatetapan[0]->tawaran_mula_elaun)) : date('d-m-Y'); ?>"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="radio">
                                <label>
                                    <input type="radio" name="jantina_baru" class="minimal" value="1" id="jantina_baru_lelaki">Lelaki
                                </label>
                                <label>
                                    <input type="radio" name="jantina_baru" class="minimal" value="2" id="jantina_baru_perempuan">Perempuan
                                </label>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="no_hp_baru" name="no_hp_baru">
                                        </div>
...
<script>
    $(document).ready(function () {
        ...
        $(document).on("click", ".open-Dialog2", function () {
            ...
            var lahirbaru = $(this).data('lahirbaru');
            //alert(lahir);
            ...
            $(".modal-body #tarikh_lahir_baru").val(lahirbaru);
            $(".modal-body #umur_asal").val(umur);
            $(".modal-body #umur_baru").val(umur);
            $(".modal-body #jantina_asal").val(jantina);
            if (jantina === "1") {
                $(".modal-body #jantina_baru_lelaki").prop('checked', true);
            } else {
                $(".modal-body #jantina_baru_perempuan").prop('checked', true);
            }
            $(".modal-body #mykad_baru").val('');
        ...
        $(document).on("click", ".open-Dialog3", function () {
            ...
            $(".modal-body #alamat_baru").val('');
            $(".modal-body #no_hp_baru").val('');
            $(".modal-body #poskod_baru").prop('selectedIndex',0);
            $(".modal-body #kewarganegaraan_baru").prop('selectedIndex',0);
            $(".modal-body #taraf_perkahwinan_baru").prop('selectedIndex',0);
        });
        $(document).on("click", ".open-Dialog4", function () {
            ...
            $(".modal-body #nama_bank_baru").prop('selectedIndex',0);
            $(".modal-body #no_akaun_baru").val('');
            $(".modal-body #nama_bank_baru").val(nama_bank_asal);
        });
