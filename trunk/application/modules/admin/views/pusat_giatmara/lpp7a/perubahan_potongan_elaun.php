...
<form class="form-horizontal" action="<?php echo site_url('admin/Pusat_giatmara/perubahan_potongan_elaun'); ?>" method="post">
    <div class="row">
...
<!--                                    <select id="giatmara" name="giatmara" class="form-control">
                                ...
                                <div class="col-md-4">
                                    <select id="kursus" name="kursus" class="form-control">
                                        ...
                                        foreach ($refKursus as $r) {
											$kursx = '';
										    if($r->id==$this->input->post('kursus')) $kursx = ' selected ';
                                            echo '<option value="' . $r->id . '"  '.$kursx.'    >' . $r->nama_kursus . '</option>';
                                        }
                                        ?>
                                    </select>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <select id="intake" name="intake" class="form-control">
                                        ...
                                        foreach ($refIntake as $r) {
											$intx='';
											if($r->id ==  $this->input->post('intake')) $intx=' selected ';
                                            echo '<option value="' . $r->id . '" '.$intx.'  >' . $r->nama_intake . '</option>';
                                        }
                                        ?>
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control" id="nama" name="nama" value="<?php echo $this->input->post('nama');?>" >
                                </div>
                            </div>
                                                ...
                                                <tbody>
                                                    ...
                                                    if ($data)
                                                        foreach ($data as $r) :
                                                            ...
                                                            <tr>
                                                                <td><?php echo ++$no; ?></td>
                                                                <td><a href="<?php echo site_url('admin/Pusat_giatmara/potongan_pelatih/'); ?><?php echo $r->id_pelatih; ?>/<?php echo $idNegeri; ?>/<?php echo $idGiatmara; ?>/<?php echo $idKursus; ?>/<?php echo $idIntake; ?>/<?php echo $nama; ?>"><?php echo $r->nama_penuh; ?></a></td>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#pagetitle").text("Perubahan Potongan (LPP7A)");
    });
