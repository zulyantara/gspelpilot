...
<form class="form-horizontal" action="<?php echo site_url('admin/Pusat_giatmara/penjanaan_lpp08'); ?>" method="post">
    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <select id="kursus" name="kursus" class="form-control">
                                        <option value="">Sila Pilih</option><?php
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#pagetitle").text("Penjanaan LPP08");
    });
