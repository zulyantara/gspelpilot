        ...
        <div class="box ">
            <div class="panel panel-custom-horrible-red"  >
                ...
                <div class="panel-body" >
                    <form class="form-horizontal" action="<?php echo site_url('admin/Pusat_giatmara/batal_pelatih'); ?>" method="post">
                        <fieldset>
                                                    ...
                                                    foreach ($dataPelatih as $r) :
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><a data-toggle="modal" data-id="<?php echo $r->id_pelatih; ?>"
                                                                   ...
                                                                   title="Batal Pelatih" class="open-Dialog btn <?php echo (($r->lpp08) ? 'btn-danger fa fa-ban' : 'btn-primary fa fa-pencil'); ?>" href="<?php echo (($r->lpp08) ? '' : '#myModal'); ?>"></a></td>
                                                        </tr>
                                                    <?php endforeach; ?>
                                            </tbody>
                                        </table>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo site_url('admin/Pusat_giatmara/batal_pelatih'); ?>" method="post">
                    <div class="form-group">
...
<script>
    $(document).ready(function () {
        $("#pagetitle").text("Batal Pelatih (LPP08)");
