...
<html lang="en">
<head>
    <title>Trashpedia Sistem Management Bank Sampah</title>
    <meta charset="utf-8">
    ...
    <!--[if (gt IE 9)|!(IE)]><!-->
    <script src="js/jqueryhom.mobile.customized.min.js"></script>
    <!--<![endif]-->
...
<!--                          @role('banksampah')-->
<!--                            <li >-->
<!--                                <a href="{{url('adm')}}" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">-->
<!--                                    Kelola </span>-->
<!--                                </a>-->
...
<!--                            @else-->
<!--                                            <li class="dropdown">-->
<!--<a href="#" class="  dropdown-toggle user-profile" data-toggle="dropdown" role="button" aria-expanded="false"> <img src="{{ URL::to('/') }}/coba/public/images/user/{{ Auth::user()->image }}" alt=""> Halo, -->
...
<!--                <h2 class="text_1 color_1">Sampah Menjadi Berkah</h2>-->
...
<!--                     <font color=#55cd4c>Apa Itu Program Bank Sampah??-->
<!--                </h2>-->
<!--            </div>-->
<!--        </div>-->
<!--        <div class="row">-->
...
<!--        <div class="row">-->
<!--            <div class="preffix_2 grid_8">-->
<!--                <h2 class="header_1 wrap_3 ">-->
<!--                    <font color=#55cd4c>Lalu Apa Itu Trashpedia???-->
<!--                </h2>-->
<!--            </div>-->
<!--        </div>-->
<!--        <div class="row">-->
...
<!--</div>-->
<!--        <h2 class="header_1 wrap_3 color_3">-->
<!--                 <font color=#55cd4c> Kelebihan Trashpedia-->
<!--        </h2>-->
...
<!--                <h3 class="text_2 color_2 maxheight1"><a href="#">Menambah Pendapatan</a></h3>-->
<!--            </div>-->
<!--        </div>-->
<!--        <div class="grid_3">-->
<!--            <div class="box_1">-->
...
<!--                    <font color=#55cd4c>Kegiatan Program Bank Sampah-->
<!--                </h2>-->
<!--            </div>-->
<!--        </div>-->
<!--        <div class="row">-->
...
<!--               <font color =#55cd4c> contacts us</font>-->
<!--            </div>-->
<!--            <div class="box_3">-->
<!--                <ul class="list_1">-->
<!--                    <li><a style="background-color: blue" class="fa fa-twitter" href="http://twitter.com"></a></li>-->
<!--                    <li><a style="background-color: red" class="fa fa-google-plus" href="http://google.com"></a></li>-->
<!--                    <li><a style="background-color: blue" class="fa fa-facebook" href="http://facebook.com"></a></li>-->
...
<body>
    <center>Maaf Sedang Masa Perbaikan Dalam 1 Minggu Ini</center>
</body>
</html>