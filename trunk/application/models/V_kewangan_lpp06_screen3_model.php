...
class V_kewangan_lpp06_screen3_model extends CI_Model {

    public $table = 'v_kewangan_lpp06_screen3';
    public $id = 'id';
    public $order = 'ASC';
    ...
    // get all
    function get_all($negeri = null, $giatmara = null, $kursus = null, $sesi = null) {
