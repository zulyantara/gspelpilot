...
class MY_Controller extends MX_Controller {
	...
	// Render template2
	// add $row_data --> Send Data to view
	// by Nino (Indonesia) July 2017

	protected function render_data($view_file, $layout = 'default',$row_data='')
	{
		// automatically generate page title
		if ( empty($this->mPageTitle) )
		{
		...
		$this->mViewData['inner_view'] = $view_file;
		$this->mViewData['row_data'] = $row_data; //add Nino Indonesia July 2017
		$this->load->view('_base/head', $this->mViewData);
		$this->load->view('_layouts/'.$layout, $this->mViewData);
...
require APPPATH."core/controllers/Alumni_Controller.php";
