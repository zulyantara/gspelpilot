    ...
    <body style="font-family:arial;font-size:12px">
        ...
        <fieldset>
            ...
            <table>
                ...
                <tr>
                    <td>Poskod</td>
                    <td>:</td>
                    <td><?php echo $butir_peribadi2["poskod_3"];?></td>
                </tr>
                <tr>
                    <td>Bandar</td>
                    <td>:</td>
                    <td><?php echo $butir_peribadi2["bandar_3"];?></td>
                </tr>
                <tr>
                    <td>Negeri</td>
                    <td>:</td>
                    <td><?php echo $butir_peribadi2["negeri_3"];?></td>
                </tr>
                <tr>
                    <td>Emel</td>
                    <td>:</td>
        ...
        <fieldset>
			...
			<tr>
                ...
                <tr>
                    <td>Bandar</td>
                    <td>: <?php echo $penjaga2['b_bandar2'];?></td>
					<td></td>
					<td>Bandar</td>
                    <td>: <?php echo $penjaga2['c_bandar2'];?></td>
                </tr>
                <tr>
                    <td>Negeri</td>
                    <td>: <?php echo $penjaga2['b_negeri2'];?></td>
					<td></td>
					<td>Negeri</td>
                    <td>: <?php echo $penjaga2['c_negeri3'];?></td>
                </tr>
                <tr>
                    <td>Pekerjaan</td>
                ...
                <tr>
                    <td valign="top">Poskod Pejabat</td>
                    <td>: <?php echo $penjaga2['b_alamat_pejabat_poskod'];?></td>
					<td></td>
					<td valign="top">Poskod Pejabat</td>
                    <td>: <?php echo $penjaga2['c_alamat_pejabat_poskod'];?></td>
                </tr>
                <tr>
                    <td valign="top">Bandar Pejabat</td>
                    <td>: <?php echo strtoupper( $penjaga2['b_alamat_pejabat_bandar2'] );?></td>
					<td></td>
					<td valign="top">Bandar Pejabat</td>
                    <td>: <?php echo $penjaga2['c_alamat_pejabat_bandar2'];?></td>
                </tr>
                <tr>
                    <td valign="top">Negeri Pejabat</td>
                    <td>: <?php echo strtoupper( $penjaga2['b_alamat_pejabat_negeri3'] );?></td>
					<td></td>
					<td valign="top">Negeri Pejabat</td>
                    <td>: <?php echo $penjaga2['c_alamat_pejabat_negeri3'];?></td>
                </tr>
                </table>
				<?php }else{?>
				<table>
                ...
                <tr>
                    <td>Bandar</td>
                    <td>:</td>
                    <td> <?php echo $penjaga2["a_bandar2"];; ?></td>
                </tr>
                <tr>
                    <td>Negeri</td>
                    <td>:</td>
                    <td> <?php echo $penjaga2["a_negeri2"]; ?></td>
                </tr>
                <tr>
                    <td>Pekerjaan</td>
                    <td>:</td>
                ...
                <tr>
                    <td>Bandar</td>
                    <td>:</td>
                    <td> <?php echo $penjaga2["a_alamat_pejabat_bandar2"];?></td>
                </tr>
                <tr>
                    <td>Negeri</td>
                    <td>:</td>
                    <td> <?php echo $penjaga2["a_alamat_pejabat_negeri3"];?></td>
                </tr>
				<?php } ?>
            </table>
        </fieldset>
