...
<html>
    ...
    <body style="font-family:helvetica;font-size:10px;margin-top:-50px">
        ...
        <table cellpadding="0" style="font-family:helvetica;font-size:10px">
            ...
            <tr>
                <td><?php echo strtoupper($row_cetak->poskod." ".$row_cetak->bandar." ".$row_cetak->negeri_poskod); ?></td>
            </tr>
            <tr>
    ...
    <table  style="font-family:helvetica;font-size:10px;padding:0px;">
        ...
        <tr>
            <td>TEMPOH</td>
            <td>:</td>
            <td><?php echo "6";//date("m", strtotime($row_cetak->tarikh_tamat))-date("m",strtotime($row_cetak->tarikh_mula)); ?> BULAN</td>
        </tr>
    </table>
  ...
  <table style="font-family:helvetica;font-size:10px">
	...
	<tr>
	  ...
	  <!--/table>
        <table style="font-family:helvetica;font-size:10px"-->
          <tr>
              <td align="justify"><br>3. Bagi tujuan pendaftaran, saudara / saudari perlu untuk melengkapi Borang Profil Pelatih, Borang Aku Janji Pelatih GIATMARA dan Borang Pemeriksaan Kesihatan. Saudara / saudari juga perlu untuk membawa dokumen-dokumen asal bagi tujuan pengesahan, 1 salinan MyKAD, 1 salinan akaun bank peribadi yang aktif dan 2 keping gambar berukuran passport.<!--/p-->

        <p style="text-align:justify">4. Kegagalan saudara / saudari untuk menepati keperluan pendaftaran serta kegagalan menghadirkan diri pada tarikh pendaftaran yang ditetapkan akan menyebabkan tawaran ini terbatal secara sendirinya.</p>
